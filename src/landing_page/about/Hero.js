  ...
  return (
    <div className='container'>
      ...
      <div className='row p-5 mt-5 border-top'>
        <div className='col-6 p-5 text-muted' style={{ lineHeightStep: '0.2', fontSize: '18px' }} >
      ...
      <div className='row p-5 mt-5 border-top'>
        <div className='row '> <h1 className='text-center mx-5 text-muted mt-5 '>Profile</h1> </div>
        <div className='row'>
